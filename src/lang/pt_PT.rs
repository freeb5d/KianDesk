...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "A ligar à rede do KianDesk..."),
        ...
        ("install_tip", "Devido ao UAC, o KianDesk não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o KianDesk no sistema."),
        ("Click to upgrade", "Clique para atualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao KianDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao KianDesk permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o KianDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [KianDesk Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep KianDesk background service", "Manter o serviço KianDesk em funcionamento"),
        ("Ignore Battery Optimizations", "Ignorar optimizações de Bateria"),
        ("android_open_battery_optimizations_tip", "Se pretender desativar esta funcionalidade, aceda à próxima página de definições da aplicação KianDesk, encontre e abra [Bateria], e desmarque [Sem restrições]"),
        ...
        ("Show KianDesk", "Mostrar KianDesk"),
        ("This PC", "Este PC"),
        ("or", "ou"),
        ("Elevate", "Elevar"),
        ...
        ("config_input", "Para controlar o ambiente de trabalho remoto com o teclado, é necessário conceder ao KianDesk as permissões de \"Monitorização de Entrada\"."),
        ("config_microphone", "Para falar à distância, é necessário conceder ao KianDesk as permissões de \"Gravar Áudio\"."),
        ...
        ("still_click_uac_tip", "Continua a exigir que o utilizador remoto clique em OK na janela do UAC do KianDesk em execução."),
        ...
        ("verify_rustdesk_password_tip", "Verificar palavra-passe do KianDesk"),
        ...
        ("scam_text1", "Se estiver ao telefone com alguém que NÃO conhece NEM em quem confia e que lhe pediu para usar o KianDesk e iniciar o serviço, não prossiga e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o KianDesk Server Pro para a versão {} ou mais recente!"),
        ...
        ("selinux_tip", "O SELinux está ativado no seu dispositivo, o que poderá impedir o KianDesk de funcionar corretamente como lado controlado."),
        ...
        ("powered_by_me", "Disponibilizado pelo KianDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir a ligação apenas se a janela do KianDesk estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço em segundo plano do KianDesk"),
        ...
        ("About KianDesk", "Sobre o KianDesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente KianDesk para a versão {} ou mais recente no lado remoto!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Por predefinição, o KianDesk verifica o certificado do servidor para os protocolos que usam TLS.\nCom esta opção ativada, o KianDesk recorrerá a ignorar a etapa de verificação e prosseguir em caso de falha de verificação."),
        ("Disable UDP", "Desativar UDP"),
        ("disable-udp-tip", "Controla se deve ser usado apenas TCP.\nQuando esta opção está ativada, o KianDesk deixa de usar a UDP 21116, sendo usada a TCP 21116 em vez dela."),
        ("server-oss-not-support-tip", "NOTA: o KianDesk server OSS não inclui esta funcionalidade."),
        ...
        ("KianDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that KianDesk can use it", "O KianDesk não consegue aceder à sessão de ambiente de trabalho no dispositivo remoto, verifique se existe uma sessão ativa e se o KianDesk a pode usar"),
        ...
        ("KianDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "O KianDesk não conseguiu obter um ecrã utilizável do XDG Desktop Portal, a biblioteca PipeWire pode ser demasiado antiga"),
        ("KianDesk could not load a GStreamer component needed for screen capture ({})", "O KianDesk não conseguiu carregar um componente do GStreamer necessário para capturar o ecrã ({})"),
