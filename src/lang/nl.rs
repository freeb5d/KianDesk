...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Gereed"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het KianDesk-netwerk..."),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om uw bureaublad op afstand te bedienen. Installeer KianDesk op het systeem om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u KianDesk toestemming geven voor Toegankelijkheid."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u KianDesk toestemming geven voor Schermopname."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u KianDesk toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [KianDesk Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep KianDesk background service", "KianDesk achtergronddienst behouden"),
        ...
        ("config_input", "Om een extern apparaat met uw toetsenbord te kunnen bedienen, moet u KianDesk toestemming voor Invoer Vastleggen geven."),
        ("config_microphone", "Om te kunnen chatten moet u KianDesk toestemming voor Microfoon geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende KianDesk."),
        ...
        ("verify_rustdesk_password_tip", "Bevestiging wachtwoord KianDesk"),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om KianDesk te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Upgrade KianDesk Server Pro naar versie {} of nieuwer!"),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor KianDesk mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het KianDesk-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt KianDesk op de achtergrond actief te houden"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Upgrade de KianDesk client naar versie {} of nieuwer op de externe computer!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standaard controleert KianDesk het certificaat van de server bij het gebruik van protocollen die TLS gebruiken. Wanneer deze optie is ingeschakeld, laat KianDesk verbindingen toe, zelfs als de verificatiestap mislukt."),
        ("Disable UDP", "UDP uitschakelen"),
        ("disable-udp-tip", "Controleert of alleen TCP moet worden gebruikt. Als deze optie is ingeschakeld, gebruikt KianDesk niet langer UDP 21116, maar TCP 21116."),
        ("server-oss-not-support-tip", "Opmerking: Deze functie is niet beschikbaar in de open-sourceversie van de KianDesk-server."),
        ...
        ("KianDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that KianDesk can use it", "KianDesk heeft geen toegang tot de bureaubladsessie op het externe apparaat, controleer of er een sessie actief is en of KianDesk die kan gebruiken"),
        ...
        ("KianDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "KianDesk kon geen bruikbaar scherm verkrijgen van de XDG Desktop Portal, de PipeWire-bibliotheek is mogelijk te oud"),
        ("KianDesk could not load a GStreamer component needed for screen capture ({})", "KianDesk kon een GStreamer-component die nodig is voor schermopname niet laden ({})"),
