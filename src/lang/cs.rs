...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Připojování k KianDesk síti..."),
        ...
        ("install_tip", "Kvůli řízení oprávnění v systému (UAC), KianDesk v některých případech na protistraně nefunguje správně. Abyste se UAC vyhnuli, klikněte na níže uvedené tlačítko a nainstalujte tak KianDesk do systému."),
        ("Click to upgrade", "Aktualizovat"),
        ("Configure", "Nastavit"),
        ("config_acc", "Aby bylo možné na dálku ovládat vaši plochu, je třeba aplikaci KianDesk udělit oprávnění pro \"Zpřístupnění pro hendikepované\"."),
        ("config_screen", "Aby bylo možné přistupovat k vaší ploše na dálku, je třeba aplikaci KianDesk udělit oprávnění pro \"Nahrávání obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby vzdálené zařízení mohlo ovládat vaše Android zařízení prostřednictví myši či dotyků, je třeba povolit, aby KianDesk mohlo používat službu „Zpřístupnění hendikepovaným“."),
        ("android_input_permission_tip2", "Přejděte na následující stránku nastavení systému, najděte a přejděte do [Nainstalované služby] a zapněte službu [KianDesk vstup]."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep KianDesk background service", "Zachovat službu KianDesk na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovat optimalizaci baterie"),
        ("android_open_battery_optimizations_tip", "Pokud chcete tuto funkci zakázat, přejděte na další stránku nastavení aplikace KianDesk, najděte a zadejte [Baterie], zrušte zaškrtnutí [Neomezeno]."),
        ...
        ("Show KianDesk", "Zobrazit KianDesk"),
        ...
        ("config_input", "Chcete-li ovládat vzdálenou plochu pomocí klávesnice, musíte udělit oprávnění KianDesk \"Sledování vstupu\"."),
        ("config_microphone", "Abyste mohli mluvit na dálku, musíte udělit oprávnění KianDesk \"Nahrávat zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále vyžaduje, aby vzdálený uživatel kliknul na OK v okně UAC spuštěného KianDesku."),
        ...
        ("verify_rustdesk_password_tip", "Ověření hesla KianDesk"),
        ...
        ("scam_text1", "Pokud telefonujete s někým, koho NEZNÁTE a komu NEDŮVĚŘUJETE a kdo vás požádal o použití služby KianDesk a její spuštění, nepokračujte v hovoru a okamžitě zavěste."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aktualizujte prosím KianDesk Server Pro na verzi {} nebo novější!"),
        ...
        ("selinux_tip", "Na vašem zařízení je povolen SELinux, což může bránit správnému běhu KianDesku jako řízené strany."),
        ...
        ("powered_by_me", "Poháněno společností KianDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Povolit připojení pouze v případě, že je otevřené okno KianDesk"),
        ...
        ("floating_window_tip", "Pomáhá udržovat službu KianDesk na pozadí"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Upgradujte prosím klienta KianDesk na verzi {} nebo novější na vzdálené straně!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Ve výchozím nastavení KianDesk ověřuje certifikát serveru u protokolů používajících TLS.\nKdyž je tato možnost povolena, KianDesk v případě selhání ověření přejde k přeskočení kroku ověření a bude pokračovat."),
        ("Disable UDP", "Zakázat UDP"),
        ("disable-udp-tip", "Určuje, zda se má používat pouze TCP.\nKdyž je tato možnost povolena, KianDesk již nebude používat UDP 21116, místo toho se použije TCP 21116."),
        ("server-oss-not-support-tip", "POZNÁMKA: KianDesk server OSS tuto funkci neobsahuje."),
        ...
        ("KianDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that KianDesk can use it", "KianDesk nemůže získat přístup k relaci plochy na vzdáleném zařízení, ověřte, že relace běží a že ji KianDesk může použít"),
        ...
        ("KianDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "KianDesk nezískal z XDG Desktop Portal použitelnou obrazovku, knihovna PipeWire může být příliš stará"),
        ("KianDesk could not load a GStreamer component needed for screen capture ({})", "KianDesk nemohl načíst komponentu GStreameru potřebnou k zachycení obrazovky ({})"),
