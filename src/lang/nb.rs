...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter tilkobling til KianDesk-nettverket..."),
        ...
        ("install_tip", "På grunn av UAC kan KianDesk ikke fungere korrekt i enkelte tillfeller på fjernskrivebordet. For å unngå UAC klikker du på knappen nedenfor for å installere KianDesk på systemet"),
        ("Click to upgrade", "Klikk for å oppgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For å kontrollere ditt skrivebord med fjernstyring må du gi KianDesk \"Access \" Rettigheter."),
        ("config_screen", "For å kunne få adgang til ditt skrivebord med fjernstyring, må du gi KianDesk \"skjerstøtte \" tillatelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhet kan kontrollere din Android-enhet via mus eller berøring, må du gi KianDesk mulighet til å bruke tjenesten \"tilgjengelighet \"."),
        ("android_input_permission_tip2", "Gå til den neste systeminnstillingssiden, søk og tast inn [installerte tjenester], aktiver [KianDesk Input] tjenesten."),
        ...
        ("android_open_battery_optimizations_tip", "Hvis du vil deaktivere denne funksjonen, gå til neste innstillingsside for KianDesk-applikasjonen, finn og åpne [Batteri], og fjern haken ved [Ubegrenset]."),
        ...
        ("config_input", "For å kunne styre fjernskrivebordet med tastatur må du gi KianDesk tillatelsen \"Inndataovervåking\"."),
        ("config_microphone", "For å kunne snakke eksternt må du gi KianDesk tillatelsen \"Ta opp lyd\"."),
        ...
        ("still_click_uac_tip", "Krever fortsatt at fjernbrukeren klikker OK på UAC-vinduet til den kjørende KianDesk."),
        ...
        ("verify_rustdesk_password_tip", "Verifiser KianDesk-passord"),
        ...
        ("scam_text1", "Hvis du snakker i telefonen med noen du IKKE kjenner OG STOLER PÅ, som har bedt deg om å bruke KianDesk og starte tjenesten, ikke fortsett og legg på umiddelbart."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Vennligst oppgrader KianDesk Server Pro til versjon {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktivert på enheten din, noe som kan hindre KianDesk i å fungere som det skal på den kontrollerte siden."),
        ...
        ("powered_by_me", "Drevet av KianDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Tillat kun tilkobling hvis KianDesk-vinduet er åpent"),
        ...
        ("floating_window_tip", "Det bidrar til å holde KianDesk-bakgrunnstjenesten i gang"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Vennligst oppgrader KianDesk-klienten til versjon {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifiserer KianDesk serversertifikatet for protokoller som bruker TLS.\nMed dette alternativet aktivert vil KianDesk falle tilbake til å hoppe over verifiseringstrinnet og fortsette ved verifiseringsfeil."),
        ("Disable UDP", "Deaktiver UDP"),
        ("disable-udp-tip", "Styrer om kun TCP skal brukes.\nNår dette alternativet er aktivert, vil KianDesk ikke lenger bruke UDP 21116, TCP 21116 brukes i stedet."),
        ("server-oss-not-support-tip", "MERK: KianDesk server OSS inkluderer ikke denne funksjonen."),
        ...
        ("KianDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that KianDesk can use it", "KianDesk får ikke tilgang til skrivebordsøkten på den eksterne enheten, kontroller at en økt kjører og at KianDesk kan bruke den"),
        ...
        ("KianDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "KianDesk fikk ingen brukbar skjerm fra XDG Desktop Portal, PipeWire-biblioteket kan være for gammelt"),
        ("KianDesk could not load a GStreamer component needed for screen capture ({})", "KianDesk kunne ikke laste en GStreamer-komponent som kreves for skjermopptak ({})"),
