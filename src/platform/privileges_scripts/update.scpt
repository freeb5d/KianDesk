on run {daemon_file, agent_file, user, cur_pid, source_dir}
  ...
  set agent_plist to "/Library/LaunchAgents/com.kiandesk.KianDesk_server.plist"
  set daemon_plist to "/Library/LaunchDaemons/com.kiandesk.KianDesk_service.plist"
