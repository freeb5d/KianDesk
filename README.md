...
KianDesk is a self-hosted remote desktop client for **Windows, macOS, and Linux**. It pairs a high-performance Rust core with a native Flutter interface, giving you fast, low-latency remote control without depending on anyone else's infrastructure.
